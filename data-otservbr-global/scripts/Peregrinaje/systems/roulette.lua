...
local function logRoulette(player, words, param)
...
local disableMovingItemsToRoulettePositions = EventCallback("CantThrowItemsToRoulette")
...
logger.info("Peregrinaje Roulette script loaded")