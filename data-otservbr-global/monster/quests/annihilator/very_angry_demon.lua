...
monster.voices = {
	...
	{ text = "I SMELL YOUR ASS!", yell = true },
	{ text = "Your resistance is useless!", yell = false },
	{ text = "MUHAHAHAHAHAHUAHAHA", yell = true },
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -175, maxDamage = -275, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
...
monster.defenses = {
	...
	armor = 40,
	mitigation = 1.74,
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_HEALING, minDamage = 400, maxDamage = 800, effect = CONST_ME_MAGIC_BLUE, target = false },
}
