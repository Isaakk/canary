...
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, text = "I am the trader of my father, The King Tibianus. I'd like to have another job but he don't let me to." })
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, text = "I am Alfredo, son of The King Tibianus." })
...
keywordHandler:addKeyword({ "desert" }, StdModule.say, { npcHandler = npcHandler, text = "Too much hot... and my father, The King, always told me that you may get cursed there." })
...
keywordHandler:addKeyword({ "thais" }, StdModule.say, { npcHandler = npcHandler, text = "The city that my father, The King Tibianus, erected." })
keywordHandler:addKeyword({ "vega" }, StdModule.say, { npcHandler = npcHandler, text = "Um... I don't think so." })
keywordHandler:addKeyword({ "venore" }, StdModule.say, { npcHandler = npcHandler, text = "Although it's the flourishing trade centre of Tibia, I don't like going there." })
keywordHandler:addKeyword({ "time" }, StdModule.say, { npcHandler = npcHandler, text = "It's almost time to journey on." })
keywordHandler:addKeyword({ "promotion" }, StdModule.say, { npcHandler = npcHandler, text = "I cannot do this as I am just a prince... yet." })
keywordHandler:addKeyword({ "king" }, StdModule.say, { npcHandler = npcHandler, text = "The King Tibianus is my father." })

npcHandler:setMessage(MESSAGE_GREET, "I am the son of The King Tibianus. I buy almost everything from everyone but my prices varies every day depending on King Tibianus needs.")
npcHandler:setMessage(MESSAGE_FAREWELL, "May the gods be with you.")
npcHandler:setMessage(MESSAGE_WALKAWAY, "Thats rude! Remember I am the Prince of Thais... or I am supposed to.")
npcHandler:setMessage(MESSAGE_SENDTRADE, "Of course, just take your time.")
...
npcConfig.shop = {
	...
	--Peregrinaje token
	{ itemName = "peregrinaje token", clientId = 19082, sell = 27000 },
...
local random = math.random(45,80)/100

for num, name in ipairs(npcConfig.shop) do

	if name and name.sell then
		name.sell = math.ceil(name.sell * random)
	end
